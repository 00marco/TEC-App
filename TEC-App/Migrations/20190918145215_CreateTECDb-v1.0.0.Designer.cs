...
namespace TEC_App.Migrations
{
    ...
    [Migration("20190918145215_CreateTECDb-v1.0.0")]
    partial class CreateTECDbv100
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TEC_App.Models.Address_Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("TEC_App.Models.Address_Location", b =>
                {
                    b.HasOne("TEC_App.Models.Address", "Address")
                        .WithMany("Address_Location_Pairs")
                        .HasForeignKey("AddressId")
                        .OnDelete(DeleteBehavior.Cascade);
